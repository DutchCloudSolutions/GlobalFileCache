...
$Path = "\\192.168.0.6\FASTData\CORE\cloudvolumes.demo.netapp.com\demoshare"
...
try
{
  ...
  $action = {
	...
	switch ($ChangeType)
	{
	  'Changed'  { "CHANGE" }
	  'Created'  { "CREATED"
		# Prepopulate the created file to the Edge cache
		Write-host "Fetching data for: " $FullPath
